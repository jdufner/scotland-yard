...
----
include::{plantUmlDir}/06_1_big_picture_game_play.puml[]
----
...
[source,java]
----
include::{sourceDir}/de/jdufner/scotland/yard/common/MrxService.java[tag=initializeMethod]
----

<1> That's the method to implement by Mr. X.
